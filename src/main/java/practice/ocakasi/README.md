...
* Data types
  ...
  * *reference type*: refers to an *object*. Their values are differen from the **value of the object**, meaning *references* do not hold the value of the object. Instead, a reference "points" to an object by storing the memory address where the object is located 
