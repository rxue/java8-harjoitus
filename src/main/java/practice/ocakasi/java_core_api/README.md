...
|`replace`          | <ul><li>`replace(char oldChar, char newChar)`</li><li>*Immutable* => returns `new` `String`</li><li>Can be chained</li></ul> | <ul><li></li><li>*Mutable* and in *builder pattern* => returns the instance per se</li><li>Can be chained</li></ul> |
