...
|`delete`           | does not exist                              | exists<ul><li>`delete(int start, int end)`</li><li>At heart, from the aspect of source code, if the `end` is greater than the length of the relevant string, `end` is set to the length of the relevant string</li></ul> |
